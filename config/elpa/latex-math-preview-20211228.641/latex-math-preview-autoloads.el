...
(cl-defsubst latex-math-preview-symbol-p (cl-x) (declare (side-effect-free error-free) (pure t)) (and (memq (type-of cl-x) cl-struct-latex-math-preview-symbol-tags) t))
(eval-and-compile (define-symbol-prop 'latex-math-preview-symbol 'cl-deftype-satisfies 'latex-math-preview-symbol-p))
...
(autoload 'copy-latex-math-preview-symbol "latex-math-preview")
